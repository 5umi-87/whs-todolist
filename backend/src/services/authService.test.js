...
const userRepository = require('../repositories/userRepository.mock');
...
const loginUser = async (email, password) => {
  ...
  // In the mock, we'll store the plain password, but in real implementation it would be hashed
  // So we'll just check if the passwords match directly

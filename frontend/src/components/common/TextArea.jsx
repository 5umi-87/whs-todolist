...
const TextArea = ({ 
  ...
  const baseClasses = 'shadow-sm block w-full sm:text-sm rounded-md focus:outline-none focus:ring-primary-main focus:border-primary-main';
  ...
  const textAreaClasses = `${baseClasses} ${variantClasses} ${disabledClass} ${className}`;
